...
__ZN9CoolClass3setEi:													; CoolClass::set(int)
LFB0:
	.cfi_startproc
	push	ebp
...
__ZN13PlainOldClass3setEi:												; PlainOldClass::set(int)
LFB2:
	.cfi_startproc
	push	ebp
	.cfi_def_cfa_offset 8
...
LFB10:
	...
	mov	ecx, eax
	call	__ZN4BaseC2Ev												; super poziv
	mov	edx, OFFSET FLAT:__ZTV9CoolClass+8								; inicijalizacija virtualne tablice klase CoolClass
	mov	eax, DWORD PTR [ebp-12]
	mov	DWORD PTR [eax], edx
	nop
	leave
...
LFB4:
	...
	call	___main
	mov	DWORD PTR [esp], 8
	call	__Znwj														; operator new, PlainOldClass poc - ide na stog
	mov	ebx, eax
	mov	ecx, ebx
	call	__ZN9CoolClassC1Ev											; Base *pb = new CoolClass; - konstruktor koji vraca pointer
